...
class Video < ApplicationRecord
  ...
  default_scope do
    select('videos.*, CASE WHEN videos.is_stream = TRUE AND videos.stream_start < NOW() AND videos.stream_end IS NULL OR videos.stream_end > NOW() THEN TRUE ELSE FALSE END as live_now')
